...
# GPS
PRODUCT_COPY_FILES += \
    device/asus/fhd/configs/gps.xml:system/etc/gps.xml
...
PRODUCT_COPY_FILES += \
    device/asus/fhd/configs/audio_policy.conf:system/etc/audio_policy.conf
...
PRODUCT_COPY_FILES += \
    device/asus/fhd/bluetooth/bt_vendor.conf:system/etc/bluetooth/bt_vendor.conf \
...
#Video
PRODUCT_COPY_FILES += \
    device/asus/fhd/media/media_profiles.xml:system/etc/media_profiles.xml \
    device/asus/fhd/media/wrs_omxil_components.list:system/etc/wrs_omxil_components.list \
    frameworks/av/media/libstagefright/data/media_codecs_google_audio.xml:system/etc/media_codecs_google_audio.xml \
    frameworks/av/media/libstagefright/data/media_codecs_google_video.xml:system/etc/media_codecs_google_video.xml \
    device/asus/fhd/media/media_codecs.xml:system/etc/media_codecs.xml \
    device/asus/fhd/media/mfx_omxil_core.conf:system/etc/mfx_omxil_core.conf \
    device/asus/fhd/media/video_isv_profile.xml:system/etc/video_isv_profile.xml
...
PRODUCT_COPY_FILES += \
    device/asus/fhd/wifi/wpa_supplicant.conf:/system/etc/wifi/wpa_supplicant.conf
...
PRODUCT_COPY_FILES += \
    ...
    device/asus/fhd/keylayout/ftxxxx_ts.kcm:system/usr/keychars/ftxxxx_ts.kcm \
    ...
    device/asus/fhd/keylayout/Vendor_0b05_Product_17fc.kl:system/usr/keylayout/Vendor_0b05_Product_17fc.kl \
    device/asus/fhd/keylayout/Vendor_0b05_Product_1803.kl:system/usr/keylayout/Vendor_0b05_Product_1803.kl
...
# NFC
PRODUCT_COPY_FILES += \
    device/asus/fhd/nfc/libnfc-brcm.conf:system/etc/libnfc-brcm.conf \
    device/asus/fhd/nfc/libnfc-brcm-20795a20.conf:system/etc/libnfc-brcm-20795a20.conf
...
# Hack my logs
PRODUCT_COPY_FILES += \
    device/asus/fhd/10logcat:system/etc/init.d/10logcat \
    device/asus/fhd/20kmsg:system/etc/init.d/20kmsg
